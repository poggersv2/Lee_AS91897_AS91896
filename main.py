...
class App(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.ENTRY_COLOUR = "#ffffff"
        self.TEXT_COLOUR = "#ffffff"
        self.BACKGROUND_COLOUR = "#2B2B2B"
        self.BORDER_COLOUR = "#2B2B2B"
        ...
        self.name_entry = ctk.CTkEntry(self, width=200, font=self.body_font, corner_radius=self.CORNER_RADIUS)
        ...
        self.last_name_entry = ctk.CTkEntry(self, width=200, font=self.body_font, corner_radius=self.CORNER_RADIUS)
...
############################################################################################################################
        ...
        self.submit_button = ctk.CTkButton(self, text="Submit",width=100, height=35, corner_radius=10, font=self.body_font)
